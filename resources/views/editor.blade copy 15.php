...
<body>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            // *** MODIFIED: Logic to handle image sizing ***
            imageUpload.addEventListener('change', (event) => {
                ...
                reader.onload = (e) => {
                    ...
                    tempImg.onload = () => {
                        ...
                        // Failsafe to get a reasonable width if not in a page
                        ...
                        // If image is wider than the page content area, scale it down
                ...
                if (rows > 0 && cols > 0 && savedRange) {
                    ...
                    for (let i = 0; i < rows; i++) {
                        ...
                        for (let j = 0; j < cols; j++) {
                            // *** MODIFIED: Use createNewCell to get default styles ***
            ...
            editor.addEventListener('contextmenu', function(e) {
                ...
                if (cell) {
                    ...
                    // *** MODIFIED: Use pageX/pageY for correct positioning on all pages ***
            ...
            // *** MODIFIED: Set default font size in new cells ***
