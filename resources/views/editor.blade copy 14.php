...
<body>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            // *** REWRITTEN LOGIC FOR CORRECT SELECTION BEHAVIOR ***

            const tableContextMenu = document.getElementById('table-context-menu');
            let currentCell = null; // The cell that was right-clicked
            let selectedCells = []; // Array of currently selected <td> or <th> elements
            ...
            editor.addEventListener('mousedown', function(e) {
                ...
                if (cell) {
                    ...
                    // If clicking outside a table, clear any existing selection
                    clearSelection();
                }
            });
            ...
            editor.addEventListener('mousemove', function(e) {
                ...
                // On the first mousemove after mousedown, we confirm a drag has started
                if (!hasDragged) {
                    hasDragged = true;
                    // Prevent default text selection behavior only when dragging starts
            ...
            // Use 'document' for mouseup to catch event even if mouse is released outside the editor
            document.addEventListener('mouseup', function(e) {
                if (!isMouseDown) return;

                // If it was just a click without a drag, clear the selection
            ...
            editor.addEventListener('contextmenu', function(e) {
                ...
                if (cell) {
                    ...
                    // If the right-clicked cell is not part of an existing selection,
                    // clear the old selection and select just this one cell.
            ...
            // Hide context menu when clicking anywhere else (except on the menu itself)
